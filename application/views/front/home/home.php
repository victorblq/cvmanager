    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container">
            <img class="img-fluid mb-5 d-block mx-auto profile-image" src="<?= base_url('uploads/img/profile.jpg')?>" alt="">
            <h1 class="text-uppercase mb-0">Victor Carvalho</h1>
            <hr class="icon-light code">
    ...
    <section class="bg-primary text-white mb-0" id="about">
        <div class="container">
            ...
            <hr class="icon-light question-circle mb-5">
            <div class="row">
                <div class="col-lg-4 ml-auto">
                    <p class="lead">Brazilian, Single, 24 years old.<br> Living in Foz do Iguaçu, Paraná, Brasil</p>
                </div>

                <div class="col-lg-4 mr-auto">
                    <p class="lead">Web developer, constant learner and a teacher in the cocoon.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-11 ml-auto">
                    <p class="lead">I seek personal and professional improvement and through my profession solve problems for other people.</p>
                </div>
            </div>
        </div>
    </section>
